	...
	<nav class="navbar navbar-default navbar-fixed-top hidden-xs">
		<div class="container container-menu">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo $site_path; ?>index.php"><img src="<?php echo $site_path; ?>img/LD_Logo_Small_a.png" height='20'></a>
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="misc"><a href="<?php echo $site_path; ?>pages/keyframes.php">Misc</a></li>
					<li class="dropdown">
