...
<div class="row">
	<div class="col-sm-4 outline">
		<img src="<?php echo $site_path; ?>img/web/web_anz.png" class="img-responsive">
	</div><!--ENDS col-->
...
<div class="row">
	<div class="col-sm-4 outline">
		<img src="<?php echo $site_path; ?>img/web/web_timesheet.png" class="img-responsive">
	</div><!--ENDS col-->
	<div class="col-sm-8 outline">
...
<div class="row">
	<div class="col-sm-4 outline">
		<img src="<?php echo $site_path; ?>img/web/web_track_stats.png" class="img-responsive">
	</div><!--ENDS col-->
	<div class="col-sm-8 outline">
